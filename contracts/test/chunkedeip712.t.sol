...
contract ChunkedEip712Test is Test {
    ...
    function loadFixture() public view returns (AnyProofFixtureJson memory) {
        ...
        string memory path = string.concat(root, "/src/fixtures/recursive-fixture.json");
    ...
    function test_ValidChunkedEip712Proof() public view {
        AnyProofFixtureJson memory fixture = loadFixture();
    ...
    function testFail_InvalidChunkedEip712Proof() public view {
        AnyProofFixtureJson memory fixture = loadFixture();
